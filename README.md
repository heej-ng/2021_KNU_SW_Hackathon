...
### :computer: 주제 선정 배경
 <img src="https://insight-prd-data.s3.ap-northeast-2.amazonaws.com/wp-content/uploads/2020/07/003.png"><br>
   [⇡ 기사 보러가기[기사1]](https://www.sktinsight.com/123940)
- 대학생들은 코로나19로 인해 대학 생활 중 <br>
 **학업 야외 활동**과 **선후배/동기간 교류를 못하게 된 점**이 가장 아쉽다고 응답했다.<br>
 이와같이 인간관계 접점이 넓어지는 대학 생활에 대면 접촉이 제한되면서 소통의 아쉬움을 많이 느끼는 것으로 파악된다.
 

<img src="https://user-images.githubusercontent.com/62900140/126696409-1da06baf-8439-45c2-96f4-68cef2802f29.png">

   [⇡ 기사 보러가기[기사2]](http://www.civicnews.com/news/articleView.html?idxno=31752) 
 
-  이러한 'UNTACT' 상황 속에서 건국대와 숭실대 등은 <br>
  **"메타버스"** 기술을 통해 비대면 축제를 개최했고 매우 긍정적인 반응이 나왔다.

- **우리는 이 긍정적인 "메타버스" 사례를 적극 활용하여 단순히 축제에 국한시키는 것이 아닌,<br>
    수업 시간,공강 시간,학업 야외 활동 등 모든 대학 생활을 선/후배,동기들과 즐길 수 있는 KNU만의 메타버스를 구현하여<br>
    '코로나 19'로 인한 제약을 극복하고자 한다.**
...
- 본 KNU 메타버스는 테스트 버전으로 경북대학교 컴퓨터 학부생들이 많이 이용하는 IT융복합관(IT5호관)을 구현하였다. <br>
- 본 KNU 메타버스에서는 학생마다 자신의 이름을 달고 융복합관 건물을 돌아다닐 수 있다. <br>
  이를 통해 융복합관 건물에서 마주친 같은과 학우들의 이름을 알 수 있다 <br>
- 각 학생들은 수업 시간에 맞춰 강의실로 이동하면 같은 강의실에 접속한 학우들과 해당 수업 담당 교수님들과 함께 채팅할 수 있는 기능이 부여된다.
- 각 강의실에 들어가면 간편하게 출석체크를 할 수 있어 교수님의 편의성을 고려하였다.
- 과 사무실에 들어가면 정보(:email:, :telephone_receiver:, :fax:)등을 얻을 수 있다. <br>
...
### :mag: 서비스 기능
#### 1. 회원가입 · 로그인 · 로그아웃 기능<br>
> 학생들은 회원가입을 할 때 이름, 비밀번호, 학번, 전공 정보를 기입한다. 또한, 로그인과 로그아웃 기능이 제공된다.

#### 2. 강의실 입장 기능
> - 본인의 수업이 있는 강의실에 학생들이 입장하면 해당 강의실 정보가 띄워진다.<br> 
> - 학생들은 on/off버튼을 눌러 간편하게 출석을 할 수 있다.
> - 온라인 강의 버튼을 누르면 해당 강의실 수업의 zoom/webex 링크가 연동되어 학생들은 온라인 화상 강의를 들을 수 있다. 
> - 학생들은 강의를 듣다가 문의사항이 있으면 버튼을 통해 바로 과사에 이동하거나 강의실에서 나갈 수 있다.

#### 3. 같은 강의실 내 유저 간 채팅 기능
> 동일한 강의를 수강하는 학생들 끼리 단체 채팅이 가능하여 학생들은 교수님, 친구들끼리 즉각적으로 소통을 가능하게 하여
> 학우들 간에 교우 관계를 다질 수 있도록 하였다.

#### 4. 과 사무실 입장 기능
> 과 사무실에 입장하면 정보(주소, 전화번호, 팩스번호)를 얻어서 학생들은 학교 생활에 필요한 정보들을 얻을 수 있다. 

#### 5. 층 이동 기능
> 엘레베이터를 이용하여 학생들이 층을 이동할 수 있는 기능 구현하였다.

<br>

### :hearts: 결론 및 기대효과
- 실제로 학교를 다니고 있는 듯한 느낌을 받을 수 있다.
...
- 캠퍼스 내의 여러 활동들을 가상으로 즐길 수 있고 이를 통해서 학교 생활을 즐길 수 있다.
...
> 
- 방향키를 통해 학교 건물을 돌아다니므로 마치 게임을 하는 듯한 재미를 줄 수 있다.
- 메타버스를 통해 기존의 대면 수업에서 이행되지 않았던 새로운 문화가 형성될 수 있다.
...
#### 2. 영상 통화 기능
> 현재는 해당 강의실에 있는 사용자들 간 단체 채팅이 가능하다. 그러나 차후에는 zoom/webex 같은 단체 영상 통화 기능을 도입하여, 
> 교수님과 학생들이 이 서비스 하나만으로 수업을 진행할 수 있게 한다. <br>
